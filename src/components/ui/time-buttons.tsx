  ...
  return (
    <div className="flex items-center gap-2 my-3 text-sm">
      ...
      {displayIntervals.map((interval) => (
        <button
          key={interval}
          className={`px-2 py-0.5 rounded text-[12.8px] border-none outline-none ${
            activeTime === interval
      ...
      <div className="relative">
        <button
          className="px-2 py-0.5 rounded bg-gray-100 dark:bg-gray-700 text-[#222] dark:text-white hover:bg-gray-200 dark:hover:bg-gray-600 flex items-center gap-1 text-[12.8px] border-none outline-none"
